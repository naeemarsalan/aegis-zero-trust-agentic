...
In the PoC, Kata Containers with `runtimeClassName: kata-qemu` (nested virt, no TEE) is the active isolation tier — see xref:29-agent-sandbox.adoc[Agent Sandbox].
